...
5. Once the available evidence is sufficient, the agent records a cycle direction, a frequency-based skill plan, concrete sessions for the week, and the smallest next action in [learner/LEARNING_STATE.md](learner/LEARNING_STATE.md).
...
learner/LEARNING_STATE.md       central goal, baseline, cycle, week, and next action
learner/VOCABULARY.md           active chunks and evidence across skills
...
Vocabulary and reusable chunks connect listening, reading, speaking, and writing; they are not a separate fifth subject. A session may integrate several skills around one useful material, but it saves evidence for each skill separately.
